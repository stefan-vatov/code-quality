...
import { noConditionalEmptyObjectSpreadRule } from '../../src/rules/no-conditional-empty-object-spread';
...
tester.run('thethracian/no-conditional-empty-object-spread', noConditionalEmptyObjectSpreadRule, {
  valid: [
    'const result = { value };',
    'const result = { ...values };',
